invoice_id, invoice_amount, currency, credit_payment (T/F), online_payment (T/F), cash_payment (T/F) , address_line, address_city, address_state, address_pincode, datetime fields
